; ModuleID = './samples/example.cc'
source_filename = "./samples/example.cc"
...
@.str = private unnamed_addr constant [14 x i8] c"Hello Worldss\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_example.cc, i8* null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_example.cc() #0 section ".text.startup" {
