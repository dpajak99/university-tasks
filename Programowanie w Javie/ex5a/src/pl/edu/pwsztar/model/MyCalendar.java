...
public class MyCalendar {
    public static final CalendarDate RefDate = new CalendarDate(30, 11, 2020, 1);
    ...
    public static CalendarDate addDaysToDate( CalendarDate calendarDate, int days ) {
        ...
        return new CalendarDate( currentDay, currentMonth, currentYear, calendarDate.getDayNumber() );
    }
    ...
    public static int getDayNumberFromRefDate( CalendarDate calendarDate ) {
        int daySum = 0;
